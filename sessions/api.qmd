...
Pour installer toutes les dépendances nécessaires pour ce tutoriel, vous pouvez taper,
...
<details open>
<summary>
Dérouler les _slides_ associées ci-dessous ou [cliquer ici](https://inseefrlab.github.io/ssphub-ateliers-slides)
pour les afficher en plein écran.
</summary>


<div class="sourceCode" id="cb1"><pre class="sourceCode yaml code-with-copy"><code class="sourceCode yaml"></code><button title="Copy to Clipboard" class="code-copy-button"><i class="bi"></i></button></pre><iframe class="sourceCode yaml code-with-copy" src="hhttps://inseefrlab.github.io/ssphub-ateliers-slides"></iframe></div>
